    ...
    return ( 
      <div className="App">
        ...
        <div className="jumbotron">
          <h1 className="display-1" style="text-align: center;">Hello, world!</h1>
          <h3 className="display-10" style="text-align: center;">-Yong Lee</h3>
          <p className="lead" style="text-align: center;">Welcome to my website! Please look around!</p>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
              ...
              {/* <!-- Portfolio container --> */}
              <div className="d-flex justify-content-between col-12 flex-wrap" style="margin-bottom: 50px;">

                {/* <!-- Profile Divs --> */}
                {/* <!-- Movies and Groovies --> */}
                <div className="card" style="width: 22rem; margin: 10px;" id="profile-div">
