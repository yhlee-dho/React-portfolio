...
import HeaderImg from './Assets/Images/waffledream_edit.jpg';
import portfolioPlaceholder from './Assets/Images/portfolio-size_300x200px.png';
            ...
            <main role="main">
              ...
              <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <div className="btn-toolbar mb-2 mb-md-0">
                  <div className="card mb-3">
                    <Image src={HeaderImg} alt="AboutMeImage"/>
              ...
              <div className="d-flex justify-content-between col-12 flex-wrap">
                ...
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="moviesGroovies"></img>
                  <div className="card-body">
                ...
                {/* <!-- Waffles Bot --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="discordBotWaffles"></img>
                  <div className="card-body">
                ...
                {/* <!-- Burger Logger --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="burgerLogger"></img>
                  <div className="card-body">
                ...
                {/* <!-- Note Taker --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="noteTaker"></img>
                  <div className="card-body">
                ...
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="profileGenerator"></img>
                  <div className="card-body">
                ...
                {/* <!-- Day Planner --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="dayPlanner"></img>
                  <div className="card-body">
                ...
                {/* <!-- Employee Tracker --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="employeeTracker"></img>
                  <div className="card-body">
                ...
                {/* <!-- Template Engine --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="Testing card"></img>
                  <div className="card-body">
                ...
                {/* <!-- Weather Dashboard --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="weatherDashboard"></img>
                  <div className="card-body">
                ...
                {/* <!-- Project 2 --> */}
                <div className="card portfolioCard" id="profile-div">
                  <img src={portfolioPlaceholder} className="card-img-top" alt="youtubeSearch"></img>
                  <div className="card-body">
